...
TTJY["2"]["BackgroundTransparency"] = 0;
TTJY["2"]["Size"] = UDim2.new(0.3, 0, 0.2, 0);
TTJY["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
TTJY["2"]["Position"] = UDim2.new(0.7, 0, -0.1899999976158142, 0);
TTJY["2"]["Name"] = [[Frame]];
TTJY["3"] = Instance.new("TextLabel", DRR["d"]);
TTJY["3"]["TextWrapped"] = true;
TTJY["3"]["BorderSizePixel"] = 0;
TTJY["3"]["TextScaled"] = true;
TTJY["3"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
TTJY["3"]["BackgroundTransparency"] = 0;
TTJY["3"]["TextXAlignment"] = Enum.TextXAlignment.Left;
TTJY["3"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.SemiBold, Enum.FontStyle.Normal);
TTJY["3"]["TextSize"] = 14;
TTJY["3"]["TextColor3"] = Color3.fromRGB(255, 0, 0);
TTJY["3"]["AutomaticSize"] = Enum.AutomaticSize.X;
TTJY["3"]["Size"] = UDim2.new(1, 0, 1, 0);
TTJY["3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
TTJY["3"]["Text"] = [[PlayerName]];
